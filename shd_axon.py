...
serialiser = Numpy("checkpoints_shd_nospace_axon" + unique_suffix)
...
compiler = EventPropCompiler(example_timesteps=max_example_timesteps,
                                ...
                                optimiser=Adam(0.001), delay_optimiser=Adam(args.delay_lr), delay_type="axonal",
...
with open(f"results_pos/acc_nospace_axon_{unique_suffix}.json", 'w') as f:
